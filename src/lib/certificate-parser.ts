...
export function parseCertificateText(rawText: string, fileName: string): ParsedCertificate {
  ...
  return {
    ...
    governmentManual: labelValue(fullJoined, "Government Manual") || labelValue(fullJoined, "Government Security Manual") || labelValue(fullJoined, "Government Standard"),
    responseTime: labelValue(fullJoined, "Response Time"),
